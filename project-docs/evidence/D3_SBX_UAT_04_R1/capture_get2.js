(function() {
    ...
    console.log('UAT04_R1_GET2_DISPATCHING', { attempt: attempt, preUtc: preUtc, app: 794, id: 15 });
    kintone.api('/k/v1/record.json', 'GET', { app: 794, id: 15 })
        .then(function(r) {
            ...
            window.__uat04_r1_get2 = payload;
            var b = new Blob([JSON.stringify(payload, null, 2)], { type: 'application/json' });
            var a = document.createElement('a');
            a.href = URL.createObjectURL(b);
            a.download = 'uat04_r1_get2_record.json';
            a.click();
            console.log('UAT04_R1_GET2_SUCCESS', { attempt: attempt, postUtc: postUtc, recordId: recId, revision: rev });
        })
        .catch(function(err) {
            var postUtc = new Date().toISOString();
            var errPayload = {
            ...
            window.__uat04_r1_get2_error = errPayload;
            var b = new Blob([JSON.stringify(errPayload, null, 2)], { type: 'application/json' });
            var a = document.createElement('a');
            a.href = URL.createObjectURL(b);
            a.download = 'uat04_r1_get2_error.json';
            a.click();
            console.error('UAT04_R1_GET2_ERROR', err);
        });
})();
