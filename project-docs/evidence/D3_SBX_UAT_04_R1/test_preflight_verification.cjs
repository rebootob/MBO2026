...
const syntheticRecord = {
    ...
    Employee_Code: { type: 'SINGLE_LINE_TEXT', value: 'mock_emp_101' },
    Requester_User: { type: 'USER_SELECT', value: [{ code: 'mock_user_101', name: 'Mock User 101' }] },
    Appraiser_1_User: { type: 'USER_SELECT', value: [{ code: 'mock_user_102', name: 'Mock User 102' }] },
    Appraiser_2_User: { type: 'USER_SELECT', value: [{ code: 'mock_user_103', name: 'Mock User 103' }] },
