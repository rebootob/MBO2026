...
R3-R34 is proposed TEST-ONLY to close only NCName validation and full direct start-tag attribute token coverage. Reference-image production source remains frozen.
