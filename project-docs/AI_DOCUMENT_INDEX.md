...
3. `AI_ACTIVE_TASK.md`;
4. `EXCEL_EXPORT.md`;
5. exact R3-R33 implementation diff in `tests/mbo-xlsx-ooxml-feasibility.test.js`.

R3-R34 is authorized TEST-ONLY to close only NCName validation and full direct Relationship start-tag attribute token coverage. Reference-image production source remains frozen.
