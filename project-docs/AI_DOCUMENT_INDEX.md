...
```text
ACTIVE_WORK_PACKAGE = D3-PRE1-R2
TITLE = App798 Provenance & Schema Precision Corrective
TYPE = EVIDENCE-ONLY / DOCS-ONLY CORRECTIVE
STATUS = EXECUTED / AWAITING CONTROL PLANE REVIEW
PARENT_D3_PRE1_R1 = PARTIAL PASS / R2 CORRECTIVE UNDER REVIEW
PARENT_D3_PRE1 = PARTIAL PASS / CORRECTIVE UNDER REVIEW
CORRECTIVE_DOCUMENT = project-docs/D3_PRE1_R2_APP798_PROVENANCE_SCHEMA_PRECISION_CORRECTIVE.md
PREVIOUS_CORRECTIVE_DOCUMENT = project-docs/D3_PRE1_R1_WORKFLOW_AUTHORITY_REOPEN_EVIDENCE_ACCURACY_CORRECTIVE.md
...
Read `AI_ACTIVE_TASK.md` and `project-docs/D3_PRE1_R2_APP798_PROVENANCE_SCHEMA_PRECISION_CORRECTIVE.md` for workflow authority, reopen evidence, and decision matrix details. Stage D1 is formally PASS / CLOSED / DURABLE. D3 remains on HOLD pending separate explicit Owner work package authorization.
