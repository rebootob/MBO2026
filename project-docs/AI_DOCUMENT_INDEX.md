...
```text
ACTIVE_WORK_PACKAGE = D3-WP001
ACTIVE_WORK_PACKAGE_TITLE = Variable 1–4 Appraiser Process Compatibility & HR Routing Self-Service Design
WORK_PACKAGE_TYPE = DESIGN / EVIDENCE-ONLY
...
DESIGN_DOCUMENT = project-docs/D3_WP001_VARIABLE_1_4_APPRAISER_PROCESS_COMPATIBILITY_DESIGN.md
...
D3_READINESS = DESIGN_COMPLETE / AWAITING_CONTROL_PLANE_REVIEW
NEXT_PERMITTED_ACTION = CONTROL_PLANE_REVIEW_OF_D3_WP001
STAGE_STATUS = D1 CLOSED / D3 DESIGN COMPLETE / IMPLEMENTATION ON HOLD
APP794_LIVE_REVISION = 70
