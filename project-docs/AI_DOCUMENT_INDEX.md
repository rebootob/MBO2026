...
- `project-docs/evidence/D3_SBX_UAT_02_EVIDENCE.md` — Existing M1_G1 real browser read-only UAT evidence record (physical desktop WinSta0\Default attach, Chrome PID 30516 window restored to login redirect, missing authenticated session stop condition, zero Kintone writes, zero mutations, all 4 test cases blocked, sanitized visual screenshot).
