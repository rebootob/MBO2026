...
- `project-docs/evidence/D3_SBX_UAT_02_EVIDENCE.md` — Existing M1_G1 real browser read-only UAT evidence record (physical desktop WinSta0\Default attach, Chrome PID 30516 authenticated session TMH, existing saved record #15 FY2026-0187 verified, all 4 read-only test cases PASS, zero Kintone API reads, zero Kintone writes, zero mutations, sanitized visual screenshots).
