...
3. `AI_ACTIVE_TASK.md`;
4. `EXCEL_EXPORT.md`;
5. exact R3-R32 authorization/implementation diff in `tests/mbo-xlsx-ooxml-feasibility.test.js`.

R3-R33 is authorized TEST-ONLY to close strict XML QName/start-tag parser proof gaps. Reference-image production source remains frozen.
