...
| **799** | Sandbox (Uncustomized Shell / 0 Records / API Delete Restricted HTTP 405) | MBO HR Control Center [Sandbox] (Superseded) | **CREATOR ONLY / DEFAULT DENY** | Historical early HRCC shell created at 04:32Z before App 800 allocation; REST API delete unsupported (HTTP 405); manual Kintone Web UI delete required |
