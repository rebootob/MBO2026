...
| **796** | Sandbox / Preview | MBO Profile & Scoring Configuration Master [Sandbox] | **WP-SCOPED WRITABLE / DEFAULT DENY** | Versioned MBO evaluation profile and scoring configuration master |
