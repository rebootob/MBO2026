...
## Complete Sanitized Enumeration of All 63 Raw Position Values with Reconciled Evidence Classification

> **Audit Date:** 2026-08-24T16:26:00+07:00  
...
> - `FROZEN_BUSINESS_RULE`: Explicit canonical title or title normalization defined in frozen governance (`DEC-023`, `DEC-035`) $\implies$ `PROFILE_MAPPING_RESOLVED`  
> - `CONFLICTING_LEGACY_MATCH`: Multi-app legacy matches with cross-app conflict and no explicit overriding rule $\implies$ **`PROFILE_MAPPING_AMBIGUOUS` (Fail Closed)**  
...
## 1. Complete 63-Position Enumeration & Self-Consistent Evidence Classification
...
| :---: | :--- | :---: | :--- | :--- | :---: | :--- | :--- | :--- | :---: |
| 1 | `Marketing Staff` | 40 | Staff & Chief | `PROFILE_STAFF_CHIEF` | **70 / 30** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Staff title governed by DEC-023/DEC-035 [App 283: 89 recs, App 305: 1 recs: App 283 (89) vs App 305 (1 legacy artifact)] | HIGH |
...
| 4 | `Marketing Chief` | 15 | Staff & Chief | `PROFILE_STAFF_CHIEF` | **70 / 30** | **`PROFILE_MAPPING_RESOLVED`** | **`DIRECT_LEGACY_MATCH`** | Direct non-conflicting legacy match in App 283 [App 283: 70 recs] | HIGH |
...
| 15 | `Deputy General Manager` | 4 | Deputy General Manager | `PROFILE_MANAGEMENT` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`DIRECT_LEGACY_MATCH`** | Direct legacy match in App 307 [App 307: 17 recs] | HIGH |
...
| 18 | `General Manager` | 3 | General Manager | `PROFILE_EXECUTIVE` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Executive GM title governed by DEC-023/DEC-035 [App 307: 4 recs, App 640: 4 recs, App 716: 2 recs] | HIGH |
...
| 20 | `Vice President` | 3 | Vice President | `PROFILE_EXECUTIVE` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`DIRECT_LEGACY_MATCH`** | Direct legacy match in App 715 [App 715: 2 recs] | HIGH |
...
| 37 | `DESIGN ENGINEER ASSISTANT MANAGER ` | 1 | Assistant Manager | `PROFILE_MANAGEMENT` | **60 / 40** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Assistant Manager title governed by DEC-035 [*(None in legacy PMS)*] | HIGH |
...
| 42 | `Senior  Manager` | 1 | Senior Manager | `PROFILE_MANAGEMENT` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Senior Manager title governed by DEC-023/DEC-035 [*(None in legacy PMS)*] | HIGH |
| 43 | `Section  Manager` | 1 | Section Manager | `PROFILE_MANAGEMENT` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Section Manager title governed by DEC-023 [*(None in legacy PMS)*] | HIGH |
...
| 46 | `Marketing  Chief` | 1 | Staff & Chief | `PROFILE_STAFF_CHIEF` | **70 / 30** | **`PROFILE_MAPPING_RESOLVED`** | **`DIRECT_LEGACY_MATCH`** | Direct non-conflicting legacy match in App 283 [App 283: 1 recs] | HIGH |
...
| 48 | `Senior Manager` | 1 | Senior Manager | `PROFILE_MANAGEMENT` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Senior Manager title governed by DEC-023/DEC-035 [App 305: 1 recs, App 643: 3 recs] | HIGH |
...
| 55 | `General manager` | 1 | General Manager | `PROFILE_EXECUTIVE` | **50 / 50** | **`PROFILE_MAPPING_RESOLVED`** | **`FROZEN_BUSINESS_RULE`** | Canonical Executive GM title governed by DEC-023/DEC-035 [*(None in legacy PMS)*] | HIGH |
...
* **Resolved Positions (`PROFILE_MAPPING_RESOLVED`):** **`34 Values`** (Representing 163 records with direct legacy or frozen rule proof)
