...
STATUS = NO ACTIVE AUTHORIZATION / D3-OBJECTIVE-UAT-COMBINED-01-R1 DELIVERED / REVIEW REQUIRED
...
- EVIDENCE_FILE = project-docs/evidence/D3_OBJECTIVE_UAT_COMBINED_01_EVIDENCE.md (SUPERSEDED BY project-docs/evidence/D3_OBJECTIVE_UAT_COMBINED_01_R1_EVIDENCE.md)
- VERDICT = REQUEST CORRECTIVE / SUPERSEDED BY R1
