...
## Current task
```text
CURRENT_WORK_PACKAGE = D3-SBX-MIGRATION-01-PREEXEC-01-R2
...
PREEXEC-01 = CORRECTIVE REQUIRED / R2 ACTIVE
PREEXEC-01-R1 = CORRECTIVE REQUIRED / DEPLOY POLLING GAP
PREEXEC-01-R2 = IMPLEMENTATION PUBLISHED / CANONICAL RUNTIME TEST PENDING
...
Next action: obtain canonical checkout runtime-test evidence for the R2 published HEAD. Do not start migration automatically.
