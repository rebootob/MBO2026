...
LAST_CLOSED_WORK_PACKAGE = D3-SBX-DEPLOY-01-PRE3-R1
...
No execution task is active. D3 sandbox migration is closed. Wait for a new explicit Owner authorization. D3 SANDBOX MIGRATION COMPLETE != PRODUCTION READY.