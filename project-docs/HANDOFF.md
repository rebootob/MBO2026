...
- **Evaluation Profile & Scoring (`DEC-023`, `DEC-024`)**: Annual Profile Freeze Policy (Single profile per FY). Mid-year promotion applies next FY. 4 Profile Families, `WEIGHTED_PART_A_B` algorithm, COCE excluded from score, Half-Up 2-decimal rounding.
