...
| D2 | 🟠 IN PROGRESS | Preservation PASS/CLOSED; reference-image source PASS/FROZEN; R3-R34 TEST-ONLY authorized |
...
- prefix matcher is broader than XML NCName and accepts invalid prefix forms such as leading digit;
- Relationship attribute scanning is not coverage-complete and can silently ignore malformed/unquoted extra attributes;
- adversarial proof must close invalid NCName and malformed attribute-region cases.

## 6. Exact current gate

Owner explicitly authorized `D2-WP003-R3-R34 TEST-ONLY` on 2026-09-02.
...
ANTIGRAVITY = AUTHORIZED ONLY FOR R3-R34 / ONE BOUNDED COMMIT
...
After ChatGPT independently reviews R3-R34 and closes the reference-image gate if justified:
