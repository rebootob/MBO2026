...
- **2026-08-24**: Finalized Hoshin Governance Architecture (`DEC-018`): Dual-level submission requirement (AND condition), ready version immutability, revision via new version creation, and single active version invariant.
