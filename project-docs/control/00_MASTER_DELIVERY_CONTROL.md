...
D3-LIVE-BUSINESS-DATE-FEAS1 = PASS / VERIFIED_RUNTIME_MECHANISM / REVIEW REQUIRED
...
LIVE_BUSINESS_DATE_PROVIDER = AUTHORITY LOCKED / ACQUISITION MECHANISM VERIFIED / IMPLEMENTATION REQUIRED / DEPLOYMENT BLOCKER (see `project-docs/evidence/D3_LIVE_BUSINESS_DATE_FEAS1_EVIDENCE.md`)
