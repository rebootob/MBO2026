...
| D3 | **BD1 OWNER DECISION RECORDED / HR CONCURRENCE PENDING; LIVE MIGRATION NOT AUTHORIZED** | PRE1 and EXE1 engineering are closed. App794 defer/no-backfill policy is resolved; scorer mapping awaits HR concurrence. |
...
D3-SBX-MIGRATION-01-BD1 = OWNER DECISION RECORDED / HR CONCURRENCE PENDING / NOT CLOSED
...
BD1 is decision/docs-only and executes zero Kintone reads/writes, zero schema/process writes and zero deployment.
