...
LIVE_BUSINESS_DATE_PROVIDER = AUTHORITY LOCKED / SERVER HEADER VERIFIED / BROWSER RUNTIME EXPOSURE UNVERIFIED / DEPLOYMENT BLOCKER (see `project-docs/evidence/D3_LIVE_BUSINESS_DATE_FEAS1_R1_EVIDENCE.md`)
