...
## 5. ความแตกต่างระหว่าง Return ปกติ กับ Controlled Reopen

| มิติการทำงาน | การ Return ปกติ (ก่อนการอนุมัติจบขั้นตอน) | การ Controlled Reopen (หลังการอนุมัติจบขั้นตอน) |
| :--- | :--- | :--- |
| **จังหวะเวลา** | เกิดขึ้นขณะที่แบบประเมินกำลังรอพิจารณา | เกิดขึ้นหลังจากแบบประเมินได้รับการอนุมัติเสร็จสมบูรณ์แล้ว |
| **ผู้สั่งการ** | ผู้อนุมัติในสายงาน (Manager / GM) | ฝ่ายบุคคล (HR Administrator) |
| **เลข Revision** | **คงเลขเดิม (Revision 1)** | **เพิ่มเลข Revision ใหม่ (`Revision 1 -> 2`)** |
| **การเก็บประวัติ** | แก้ไขข้อมูลในรอบเดิม | บันทึกสำเนา Revision เดิมเข้าสู่ Archive App แบบ Immutable |
| **Kintone Record** | **ใช้ Record เดิม ไม่สร้างใหม่** | **ใช้ Record เดิม ไม่สร้างใหม่ (Same Record Key)** |
