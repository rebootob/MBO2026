...
Set `KINTONE_BASE_URL` and either `KINTONE_API_TOKEN` or `KINTONE_USERNAME` plus `KINTONE_PASSWORD` before running `npm run connection:test`. The connection test makes a GET request to App 53 only.
