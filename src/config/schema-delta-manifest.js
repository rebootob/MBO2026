...
export const LOCAL_SCHEMA_DELTA_MANIFEST = {
  version: '2.0.0-FINAL-CORRECTION',
  preparedAt: '2026-08-27T07:44:00Z',
  targetApps: {
    App794: {
    ...
    App797: {
      appName: 'MBO Hoshin Master [Sandbox]',
      appId: 797,
      missingFields: [
    ...
    App800: {
      appName: 'MBO HR Control Center [Sandbox]',
      appId: 800,
      missingFields: [
        ...
        { code: 'Password_Max_Age_Days', type: 'NUMBER', label: 'Password Max Age Days', required: false },
        { code: 'Failed_Login_Threshold', type: 'NUMBER', label: 'Failed Login Threshold', required: false },
        { code: 'Lock_Duration_Minutes', type: 'NUMBER', label: 'Lock Duration Minutes', required: false },
        { code: 'Config_Status', type: 'DROP_DOWN', label: 'Config Status', required: true, options: ['DRAFT', 'ACTIVE', 'ARCHIVED'] }
      ]
    },
    App801: {
      appName: 'MBO Employee Authentication & MFA Credential Store [Sandbox]',
      appId: 801,
      missingFields: [
